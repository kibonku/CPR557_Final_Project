    ...
    const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo)
{
    ...
    auto bindingDescriptions = (configInfo.pointLineRendering) ? MyModel::PointCurve::getBindingDescriptions() : MyModel::Vertex::getBindingDescriptions();
    auto attributeDescriptions = (configInfo.pointLineRendering) ? MyModel::PointCurve::getAttributeDescriptions() : MyModel::Vertex::getAttributeDescriptions();
